...
#based on collecting preferences from many other users.
...
#can now delineate our matrix of relevant users
...
#We will then find the class and dimensions of our similarity matrix that is 
#contained within model_info. Finally, we will generate a heatmap, that 
#will contain the top 20 items and visualize the similarity shared between them.
...
#we will carry out the sum of rows and columns with the 
